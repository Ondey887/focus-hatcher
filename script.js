...
const PRICES = { common: 15, rare: 150, legendary: 5000, mythic: 50000 };
...
const ALL_PETS_FLAT = [...petDatabase.common, ...petDatabase.rare, ...petDatabase.legendary, ...petDatabase.mythic, "god"];
